...
function showPage(pageId) {
    ...
    // App Mode Toggle (hides Start Free button, forces white logo text)
    if (pageId === 'app') {
        ...
        entries.forEach(entry => {
            ...
            if (entry.isIntersecting && scrollingDown && !isFlashing) {
                ...
                if (overlay) {
                    ...
                    // Remove class after animation ends (animation is ~0.95s)
                    setTimeout(() => {
